...
public class SetLineJoinStyle extends org.apache.pdfbox.util.operator.SetLineJoinStyle {
    ...
    public void process(PDFOperator operator, List<COSBase> arguments) throws IOException {
        ...
        if (stroke == null) {
            extractor.setStroke(new BasicStroke(1, BasicStroke.CAP_SQUARE, lineJoinStyle));
        } else {
            extractor.setStroke(new BasicStroke(stroke.getLineWidth(), stroke.getEndCap(), lineJoinStyle,
