...
public class SetLineCapStyle extends org.apache.pdfbox.util.operator.SetLineCapStyle {
    ...
    public void process(PDFOperator operator, List<COSBase> arguments) throws IOException {
        ...
        if (stroke == null) {
            extractor.setStroke(new BasicStroke(1, lineCapStyle, BasicStroke.JOIN_MITER));
        } else {
            extractor.setStroke(new BasicStroke(stroke.getLineWidth(), lineCapStyle, stroke.getLineJoin(),
