...
public class SetLineWidth extends org.apache.pdfbox.util.operator.SetLineWidth {
    ...
    public void process(PDFOperator operator, List<COSBase> arguments) throws IOException {
        ...
        if (stroke == null) {
            extractor.setStroke(new BasicStroke(lineWidth, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER));
        } else {
            extractor.setStroke(new BasicStroke(lineWidth, stroke.getEndCap(), stroke.getLineJoin(),
